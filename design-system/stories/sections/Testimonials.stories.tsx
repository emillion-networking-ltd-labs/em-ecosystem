...
const REVIEWS = [
  {
    ...
    rating: 5,
    quote:
      "From the first call they understood exactly what we needed. The result speaks for itself.",
    href: "#",
  },
  {
    name: "Liam Carter",
    role: "1 month ago",
    rating: 5,
    quote: "Fast, clear and genuinely skilled. We launched ahead of schedule.",
    href: "#",
  },
  {
    name: "Sofia Reyes",
    ...
    rating: 4,
    quote:
      "A pleasure to work with — thoughtful, responsive and detail-obsessed.",
    href: "#",
  },
  {
    name: "Noah Patel",
    ...
    rating: 5,
    quote:
      "Best team we've worked with. They treat your product like their own.",
    href: "#",
  },
  {
    name: "Mia Fontaine",
    role: "3 months ago",
    rating: 5,
    quote: "Strategy, design and build all under one roof, and all excellent.",
    href: "#",
  },
  {
    name: "Ethan Cole",
...
const QUOTES = [
  {
    ...
    role: "CTO, Atlas",
    quote:
      "They understood the brand from the very first call and never lost the thread.",
    href: "#",
  },
  {
    name: "Liam Carter",
    role: "Founder, Verde",
    quote: "Fast, clear and genuinely skilled — a rare combination.",
    href: "#",
  },
  {
    name: "Sofia Reyes",
    role: "Head of Product, Norte",
