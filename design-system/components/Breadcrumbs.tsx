          ...
          {middleItems.length > 0 && (
            <div ref={menuRef} className="relative flex items-center gap-1">
              ...
              {menuOpen && (
                ...
                // border-line-strong bg-surface-elevated shadow-card gap-0.5; items h-10 px-6
                // py-2.5 rounded-md, text-content-primary hover:bg-surface-subtle. A leading chevron
                // per item echoes the breadcrumb separator.
                <ul
                  role="menu"
                  className="absolute left-0 top-full z-50 mt-1 flex max-h-64 w-fit min-w-[var(--dropdown-min)] flex-col gap-0.5 overflow-auto rounded-xl border border-line-strong bg-surface-elevated p-6 shadow-card animate-dropdown-down"
                >
