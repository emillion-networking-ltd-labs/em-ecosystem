...
// `border-line-control` + outline de foco que cambia en hover/focus/error). Tokens del proyecto. El
...
export default function Textarea({
  ...
  return (
    <textarea
      rows={rows}
      disabled={disabled}
      className={`w-full resize-y rounded-lg border border-line-control bg-transparent px-4 py-3 text-body leading-6 text-content-primary outline-solid outline-2 outline-offset-2 transition-colors placeholder:text-content-placeholder ${outline} ${
