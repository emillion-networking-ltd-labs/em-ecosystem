// WordRotate — Magic UI (MIT, © Magic UI), adoptado (ECO-105, fase 1 / ADR-019). Rota entre palabras con
// fade up/down (titulares de hero dinámicos). VERBATIM: el color/tamaño los define el consumidor por
