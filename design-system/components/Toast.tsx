...
export default function Toast({
  ...
  return (
    <motion.div
      ...
      role="alert"
      aria-live="assertive"
      className="pointer-events-auto group grid w-fit max-w-[var(--toast-max)] grid-cols-[14px_1fr_auto] items-start gap-x-2 rounded-3xl border border-line-strong bg-surface-primary py-3 pl-5 pr-4"
    >
