...
export const searchTriggerSpecs = {
  container: {
    style:
      "Button outline-solid sm tokens — rounded-md border-line-control h-8 px-4 py-1.5",
...
export default function SearchTrigger({
  ...
  return (
    <button
      onClick={onClick}
      className={`inline-flex items-center gap-2 rounded-md border border-line-control bg-transparent px-4 py-1.5 text-caption text-content-primary transition-colors hover:bg-surface-subtle h-8 ${className}`}
    >
