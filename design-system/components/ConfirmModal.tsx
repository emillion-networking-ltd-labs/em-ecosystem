...
export const confirmModalSpecs = {
  ...
  layout: {
    ...
    topSection:
      "bg-surface-primary p-6 sm:p-6 p-4 border-b border-line-default",
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-(--overlay)">
      <div
        ...
        className={`group w-full ${sizeClasses[size]} mx-4 max-h-[90vh] overflow-y-auto rounded-xl border border-line-strong bg-surface-secondary shadow-card`}
      >
        {/* Top section */}
        <div className="relative rounded-t-xl border-b border-line-default bg-surface-primary p-4 sm:p-6">
