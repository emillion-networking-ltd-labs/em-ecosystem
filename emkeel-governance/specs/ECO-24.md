...
## Scope
- Skill `/launch-satellite` (onboarding): la conversación de los 5 modos + el ensamblado del brief.
...
## Acceptance Criteria
1. **Skill `/launch-satellite` (onboarding)** existe y, conversacionalmente, conduce los **5 modos** (a–e) hasta un brief.
