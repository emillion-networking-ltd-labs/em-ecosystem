    ...
    <div className="rounded-2xl border border-border-default bg-surface-primary p-6 shadow-card">
      ...
      <div className="mb-6 flex items-center gap-4">
        ...
        <div className="flex flex-col gap-1">
          <button type="button" className="text-body-sm font-medium text-content-primary hover:underline">
            Upload photo
          </button>
          <button type="button" className="text-body-sm text-content-tertiary hover:text-error">
            Remove
          </button>
        </div>
      </div>
