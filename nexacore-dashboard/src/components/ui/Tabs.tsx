...
const variantStyles = {
  solid: {
    ...
    active:
      "bg-surface-inverse text-content-inverse font-medium transition-opacity hover:opacity-90",
    inactive:
      "bg-transparent text-content-primary font-medium transition-colors hover:bg-surface-subtle",
  },
  subtle: {
    container:
  ...
  nav: {
    ...
    active: "bg-surface-subtle rounded-full font-medium text-content-primary",
    inactive:
      "font-medium text-content-primary hover:bg-surface-subtle rounded-xl",
  },
  "nav-horizontal": {
    container: "gap-1",
    active: "bg-surface-subtle rounded-full font-medium text-content-primary",
...
export const tabsSpecs = {
  variants: {
    ...
    nav: "Active: bg-surface-subtle rounded-full | Inactive: transparent rounded-xl (vertical sidebar)",
  ...
  nav: {
    ...
    chevron: "ChevronRight 16px text-content-primary/20 — inactive only",
        ...
        return (
          ...
          >
            {isNav && !isActive && (
              <ChevronRight
                size={16}
                className="shrink-0 text-content-primary/20"
              />
            )}
