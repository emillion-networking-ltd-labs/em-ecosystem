...
export default function NavBar({
  ...
  return (
    <header className="sticky top-0 z-20 flex h-[68px] items-center border-b border-line-default bg-surface-primary">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {dropdownOpen && (
              <div className="absolute right-0 top-full mt-1 w-48 rounded-xl border border-line-strong bg-surface-primary p-2 shadow-card animate-dropdown-down">
                <Link
                  href="/profile"
