<!--
  keel-contract · contract-version: 4 · generada el 2026-08-22, subida el 2026-09-03.
  La versión 4 mueve la normativa del paquete: se consulta bajo `emkeel/governance/norms/`, y
  `emkeel/docs/` ya no existe. **Una capa sin reinstalar apunta a esa ruta muerta**: su guardián
  sigue funcionando, pero la frase que dice dónde consultar la normativa señala al vacío hasta que
  se reinstale.
