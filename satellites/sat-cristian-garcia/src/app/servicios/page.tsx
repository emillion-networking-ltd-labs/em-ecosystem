...
function ServiceCard({ service, index }: { service: Service; index: number }) {
  ...
  return (
    ...
    >
      <div id={service.id} className="card-flat transition-all hover:border-border-components scroll-mt-24">
        <div className="flex items-start gap-5">
          <span className="text-3xl font-black text-accent">{String(index + 1).padStart(2, "0")}</span>
          <div className="flex-1">
            ...
            <div className="mt-4">
              <Accordion items={[{ title: "Que incluye", children: (
        ...
        <section className="bg-surface-secondary py-20">
          <div className="mx-auto max-w-7xl px-6">
            <div className="mb-12 text-center">
              <p className="text-[18px] leading-7 md:text-h1 font-semibold tracking-wide text-accent">Servicios »»</p>
              <h1 className="mt-2 text-display text-content-primary">Lo que ofrezco.</h1>
              <p className="mx-auto mt-3 max-w-xl text-base text-content-secondary">Un sistema completo de entrenamiento, nutrición y seguimiento para resultados reales.</p>
            </div>
