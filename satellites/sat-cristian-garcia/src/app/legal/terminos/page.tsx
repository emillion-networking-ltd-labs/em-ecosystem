        ...
        <section className="bg-surface-secondary py-20">
          <div className="mx-auto max-w-3xl px-6">
            ...
            <div className="mt-6 space-y-5 text-base leading-relaxed text-content-secondary">
              ...
              <p>
                Entrenamiento personal y asesoramiento nutricional online.
                Programación, planificación nutricional y seguimiento según plan
                contratado.
              </p>
              <h2 className="text-h2 font-semibold text-content-primary">
                2. Pago
              ...
              <p>
                Cancelación con 7 días de preaviso. No se reembolsa el período
                en curso.
              </p>
              <h2 className="text-h2 font-semibold text-content-primary">
                4. Responsabilidad
              ...
              <p>
                Los programas son orientativos y no sustituyen al consejo
                médico.
              </p>
              <h2 className="text-h2 font-semibold text-content-primary">
              ...
              <p>
                Todo el material entregado es propiedad de Cristian García
                Espadas y no puede ser distribuido sin autorización.
              </p>
            </div>
          </div>
        </section>
