    ...
    >
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mb-10 flex flex-wrap items-center justify-center gap-x-3 gap-y-1">
          <span className="text-[18px] leading-7 md:text-h1 font-semibold tracking-wide text-accent">Portfolio »»</span>
          <h2 className="text-[18px] leading-7 md:text-h1 font-bold text-content-primary">Resultados reales</h2>
        </div>
        ...
        >
          <div className="px-8 py-5 sm:px-10 sm:py-6" style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}>
            ...
            >
              <p>
                Cristian García, campeón de Andalucía y campeón de España Sub‑23, es un fisicoculturista profesional reconocido por alcanzar el Top 15 en el torneo internacional Míster Universo. Su trayectoria lo posiciona como uno de los entrenadores más sólidos en transformación física, recomposición corporal y entrenamiento online.
              </p>
              <p>
                Su método combina planificación avanzada, técnica depurada y resultados reales demostrados en sus clientes. Una carrera destacada en medios como{" "}
                <a
                ...
                {" "}consolida su reputación en el panorama nacional del culturismo natural.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mt-6 flex items-center">
        ...
        <div className="px-6">
          <Button variant="link" as="a" href="/portfolio">VER PORTFOLIO COMPLETO</Button>
        </div>
        <div className="flex-1 border-t border-dashed border-accent dark:border-border-strong" />
      </div>
    </section>
