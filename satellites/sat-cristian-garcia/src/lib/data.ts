...
export const services = [
  {
    ...
    shortDesc: "Rutinas diseñadas para tu cuerpo, objetivos y ritmo de vida.",
    fullDesc:
      "Cada programa está basado en tu nivel, objetivos y disponibilidad. Sin plantillas. Analizo tu situación, diseño un plan progresivo y lo ajusto semana a semana.",
    features: [
  ...
  },
  {
    ...
    shortDesc: "Planes basados en ciencia, adaptados a tu día a día.",
    fullDesc:
      "Diseño planes alimenticios basados en evidencia, adaptados a tus gustos y restricciones. Calculo macros, estructuro comidas y te enseño a comer bien para siempre.",
    features: [
  ...
  },
  {
    ...
    shortDesc: "Revisiones semanales y ajustes en tiempo real.",
    fullDesc:
      "Cada semana reviso tu progreso, analizo mediciones, evalúo rendimiento y ajusto todo. Contacto directo conmigo por WhatsApp.",
    features: [
      "Check-in semanal",
      "Análisis con fotos",
      "Ajuste continuo",
  ...
  },
  {
    ...
    shortDesc: "Recomendaciones honestas de lo que realmente funciona.",
    fullDesc:
      "Te digo exactamente qué tomar, cuándo y por qué. Basado en evidencia y en mi experiencia como competidor. Sin patrocinios.",
    features: [
      "Solo con evidencia",
      "Dosificación óptima",
  ...
  },
  {
    id: "videollamadas",
    title: "Videollamadas",
    shortDesc: "Sesiones en vivo para técnica y planificación.",
    fullDesc:
      "Reserva una sesión para revisar técnica, planificar tu siguiente fase o resolver dudas complejas.",
    features: [
      "Revisión de técnica",
      "Planificación",
      "Resolución de dudas",
  ...
  },
  {
    ...
    shortDesc: "Fáciles, deliciosas y con macros calculados.",
    fullDesc:
      "Acceso a mi colección personal de recetas: todas calculadas, fáciles de preparar y pensadas para rendir.",
    features: [
      "Macros calculados",
      "15-30 min preparación",
...
export const testimonials = [
  {
    name: "María L.",
    quote:
      "En 4 meses he conseguido lo que no pude en 3 años sola. Cristian no solo te entrena, te educa.",
    result: "-12kg de grasa",
  },
  {
    name: "Carlos R.",
    quote:
      "Pensé que a los 45 ya no podía cambiar. Me equivocaba. El seguimiento semanal es brutal.",
    result: "+8kg de músculo",
  },
  {
    name: "Ana P.",
    quote:
      "Las recetas me salvaron. Por fin como rico y sigo avanzando. Lo mejor: aprendí a hacerlo sola.",
    result: "Competidora amateur",
  },
  {
    name: "Javi M.",
    quote:
      "Llevo 2 años con Cristian. El mejor dinero que he invertido en mi salud.",
...
export const pricingPlans = [
  {
    ...
    price: "89",
    period: "/mes",
    description: "Para quien empieza.",
    features: [
  ...
  },
  {
    ...
    price: "249",
    period: "/mes",
    description: "Competidores y transformaciones.",
    features: [
      "Todo lo del Pro",
      "Check-in 2x/semana",
      "2 videollamadas/mes",
...
export const aboutContent = {
  ...
  subtitle:
    "Campeón de España Sub 23 · Finalista Míster Universo · Entrenador Certificado",
  paragraphs: [
  ...
  timeline: [
    {
      ...
      description:
        "Mi padre fue mi primer entrenador y compañero. Lo que empezó como una rutina compartida en un gimnasio casero se convirtió en pasión.",
    },
    {
      eyebrow: "Primer título",
      title: "Campeón de Andalucía",
      description:
        "Mi primera victoria regional. La validación de que el método y la constancia funcionan.",
    },
    {
      eyebrow: "Nivel nacional",
      title: "Campeón de España Sub 23",
      description:
        "Título nacional Sub 23. El salto definitivo de aficionado a competidor profesional.",
    },
    {
      eyebrow: "Escena mundial",
      title: "Top 15 Míster Universo",
      description:
        "Entre los 15 mejores del mundo. Prueba de que la planificación y la consistencia compiten al máximo nivel.",
    },
    {
      eyebrow: "Hoy",
      title: "+500 clientes transformados",
      description:
        "Aplico el mismo método con el que llegué al podio: ciencia, consistencia y atención personal con cada uno de mis clientes.",
    },
  ],
  credentials: [
    "Campeón Andalucía",
    "Campeón España Sub 23",
    "Top 15 Míster Universo",
    "Asesor Nutricional",
    "+500 Clientes",
  ],
};
