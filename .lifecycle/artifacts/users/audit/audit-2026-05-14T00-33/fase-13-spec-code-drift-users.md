...
module: users
audit_folder: ai-specs/changes/users/audit/audit-2026-05-14T00-33
date: '2026-05-14T00:33:32Z'
...
- check_id: D-02
  ...
  verdict: PASS
  severity: HIGH
  evidence: 'live endpoints in users/: 13 all documented in api-spec.yml'
  standard: SOC 2 CC8.1
- check_id: D-03
  requirement: No spec-only endpoints (module scope)
  verdict: PASS
  severity: MEDIUM
  evidence: 'spec endpoints in users scope: 13 all implemented'
  standard: OpenAPI 3.0
- check_id: D-04
  requirement: Aligned endpoints have consistent method+path
  verdict: PASS
  severity: HIGH
  evidence: 'aligned endpoints: 0 method mismatches across 9 shared paths'
  standard: OpenAPI 3.0
- check_id: D-05
  requirement: data-model.md documents baseline-owned models
  verdict: N/A
  severity: HIGH
  evidence: "module users has no stable-baseline.md \u2192 no canonical owned-models list"
- check_id: D-06
...
- check_id: D-07
  ...
  verdict: N/A
  severity: LOW
  evidence: "module=users \u2014 UI checks N/A for backend modules"
- check_id: D-08
...
# Fase 13 (Spec-Code Drift) — users

Module: `users`. Controller prefixes detected: ['/users'].
Spec endpoints in module scope: 13 (of 99 total). Live endpoints: 13. Prisma models live: 10. data-model rows: 21.
