describe('validateProductionSecrets', () => {
  ...
  describe('GOOGLE_CALLBACK_URL', () => {
    ...
    it('should throw when GOOGLE_CALLBACK_URL is not HTTPS', () => {
      process.env.GOOGLE_CALLBACK_URL = 'http://app.example.com/auth/google/callback';
  ...
  describe('GITHUB_CALLBACK_URL', () => {
    ...
    it('should throw when GITHUB_CALLBACK_URL is not HTTPS', () => {
      process.env.GITHUB_CALLBACK_URL = 'http://app.example.com/auth/github/callback';
